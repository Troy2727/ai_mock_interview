<h1 align="center">PreWiseAI: AI-Powered Interview Preparation Platform</h1>

<p align="center">
  <img src="https://raw.githubusercontent.com/Troy2727/ai_mock_interview/main/public/robotai.png" alt="PreWiseAI Platform Screenshot" width="800" />
</p>
...
PreWiseAI is a comprehensive interview preparation platform that leverages AI to help job seekers practice and improve their interview skills. With realistic mock interviews and detailed feedback, users can gain confidence and perform better in actual job interviews.

## <a name="introduction">🤖 Introduction</a>

Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, styled with TailwindCSS and using Vapi's voice agents, PreWiseAI is a platform designed to revolutionize interview preparation. The platform offers a sleek and modern experience with AI-powered mock interviews that adapt to your specific needs and provide detailed feedback to help you improve.
...
```bash
git clone https://github.com/Troy2727/ai_mock_interview.git
...
@theme {
  ...
  --bg-pattern: url("https://raw.githubusercontent.com/Troy2727/ai_mock_interview/main/public/pattern.png");
}
...
@utility pattern {
  @apply bg-[url('https://raw.githubusercontent.com/Troy2727/ai_mock_interview/main/public/pattern.png')] bg-top bg-no-repeat;
}
