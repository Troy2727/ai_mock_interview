...
if (!mounted) return null;
 ...
 <p className='sm:text-2xl text-[16px] text-center mt-3 justify-center items-center'>Interviews are tough — but they don't have to be.</p>
<p className='sm:text-2xl text-[16px] text-center justify-center items-center' >Create personalized mock interviews, see how others tackled theirs, </p>
<p className='sm:text-2xl text-[16px]  text-center justify-center items-center'> and get real feedback that helps you truly improve.
</p>
</div>
 </div>
 </div>
